...
var file_openfga_v1_authzmodel_proto_rawDesc = []byte{
	...
	0x64, 0x55, 0x73, 0x65, 0x72, 0x73, 0x65, 0x74, 0x42, 0x9d, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d,
	0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x66, 0x67, 0x61, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x41, 0x75, 0x74,
	0x68, 0x7a, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x31,
...
var file_openfga_v1_authzmodel_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_openfga_v1_authzmodel_proto_goTypes = []interface{}{
	...
	nil,                        // 14: openfga.v1.TypeDefinition.RelationsEntry
	nil,                        // 15: openfga.v1.Metadata.RelationsEntry
}
var file_openfga_v1_authzmodel_proto_depIdxs = []int32{
	...
	14, // 1: openfga.v1.TypeDefinition.relations:type_name -> openfga.v1.TypeDefinition.RelationsEntry
	...
	15, // 6: openfga.v1.Metadata.relations:type_name -> openfga.v1.Metadata.RelationsEntry
	...
	10, // 20: openfga.v1.TypeDefinition.RelationsEntry.value:type_name -> openfga.v1.Userset
	5,  // 21: openfga.v1.Metadata.RelationsEntry.value:type_name -> openfga.v1.RelationMetadata
